...
### Added
- Rules Editor:
  - Category-based filtering of foods when building rules.

### Changed
- Updated branding:
  - Application logo/icon.
  - Enhanced **About** dialog with version, author, description, website link, and license reminder.
...
[Unreleased]: https://github.com/angelsotob/menus-app/compare/v0.6.1...HEAD
[0.6.1]: https://github.com/angelsotob/menus-app/compare/v0.6.0...v0.6.1
